...
export default function FilteredOpenIssues(props: showIssuesProps) {
    ...
    return (
        <div>
            <Button sx={{marginLeft:'2em', backgroundColor:'#1F2937'}} variant="contained" size='small' onClick={handleClickOpen}>
                Opened Issue
            </Button>
            <Dialog
                open={open}
                ...
                <DialogContent>
                    <DialogContentText>
                        <Table sx={{backgroundColor: '#6B7280'}}>
                            ...
                            <TableBody>
                                {props.issues.filter(issue=> issue.state==='open')
                                    .map((issues) => {
                                        return (
